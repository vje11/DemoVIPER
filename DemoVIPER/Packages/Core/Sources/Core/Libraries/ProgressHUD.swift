...
public extension ProgressHUD {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    class func show(_ status: String? = nil, interaction: Bool = true, inParentView: UIView? = nil) {

        DispatchQueue.main.async {
            shared.setup(status: status, hide: false, interaction: interaction, parentView: inParentView)
        }
    }
...
public class ProgressHUD: UIView {
    ...
    private var labelStatus: TLabel?
    ...
    private var fontStatus      = UIFont.systemFont(ofSize: 14, weight: .regular)
    ...
    private func setup(status: String? = nil, progress: CGFloat? = nil, animatedIcon: AnimatedIcon? = nil, staticImage: UIImage? = nil,
                       hide: Bool, interaction: Bool, delay: TimeInterval? = nil, parentView: UIView? = nil) {
    ...
    private func setupBackground(_ interaction: Bool) {
        ...
        if (viewBackground == nil) {
//            let mainWindow = parentView ?? UIApplication.shared.windows.first ?? UIWindow()
...
private class ProgressView: UIView {
    ...
    private var labelPercentage: TLabel = TLabel()
